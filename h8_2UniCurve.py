...
class hUniCurve:
    ...
    def GetResources(self):
        return {"MenuText": "hUniCurve",
                "Accel": "Ctrl+t",
                "ToolTip": "Creates and displays a Uniform B-Spline curve that passes through the end control points.",
                "Pixmap": os.path.dirname(__file__)+"./resources/8.2.svg"
        }
...
Gui.addCommand('hUniCurve',hUniCurve())